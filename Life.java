...
class Life extends JFrame implements ActionListener
{
	...
	private JButton runButton, pauseButton, resumeButton, resetButton, randColorButton;
	private Boolean isRandomColor = false;
	
	// private JToggleButton randColorButton
	...
	Life(String fileName) throws IOException
	{
		...
		randColorButton = new JButton("Random Colors");
		randColorButton.addActionListener(this);
		randColorButton.setEnabled(false);
		controlPanel.add(randColorButton);		
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ( b == runButton )
		{
			...
			randColorButton.setEnabled(true);
		}
		...
		if ( b == randColorButton )
		{
			if (this.isRandomColor) {
				model.resetMonoColor();
				randColorButton.setText("Random Colors");
			} else {

				model.randomColors();
				randColorButton.setText("Mono Color");
